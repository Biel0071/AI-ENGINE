...
(function() {
  function renderPanels() {
    const panels = {
      ...
      cmdProjectsContainer: '<div style="padding: 10px; font-size: 11px;"><table style="width: 100%; text-align: left; border-collapse: collapse;"><tr style="border-bottom: 1px solid #333; color: #888;"><th style="padding: 4px;">PROJECT</th><th style="padding: 4px;">STATUS</th><th style="padding: 4px;">AGENTS</th></tr><tr><td style="padding: 6px 4px; color: #fff;">FÊNIX OS Core</td><td style="padding: 6px 4px; color: var(--green);">ATIVO</td><td style="padding: 6px 4px;">3</td></tr><tr><td style="padding: 6px 4px; color: #fff;">AI City Engine</td><td style="padding: 6px 4px; color: var(--green);">ATIVO</td><td style="padding: 6px 4px;">2</td></tr><tr><td style="padding: 6px 4px; color: #fff;">Memory Fabric 2.0</td><td style="padding: 6px 4px; color: var(--accent);">BUILDING</td><td style="padding: 6px 4px;">1</td></tr></table></div>',
...
`;
fs.writeFileSync('grg/public/command-center.js', js, 'utf8');
