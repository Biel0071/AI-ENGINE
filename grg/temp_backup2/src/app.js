...
async function createApp(options = {}) {
  ...
  const { PerceptionEngine } = require('./ai-city/perception-engine');
  ...
  app.perceptionEngine = new PerceptionEngine({ store, bus, controlPlane });
  jobs.register('perception.capture', (payload, context) => app.perceptionEngine.captureVisualMemory(context.tenantId, context.actorId, payload));
