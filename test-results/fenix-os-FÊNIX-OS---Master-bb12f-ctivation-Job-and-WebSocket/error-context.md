...
- Name: fenix-os.spec.js >> FÊNIX OS - Master Agentic IDE >> Gate 3, 4, 5, 6: Chat Execution, Agent Activation, Job and WebSocket
- Location: tests\e2e\fenix-os.spec.js:28:3
...
Call log:
  - waiting for locator('button[data-tab="chat"]')
